	...
	let fsizedoc = '1'.repeat(10)    
     ...
     if (buffer) try { (type = await conn.getFile(buffer), buffer = type.data) } catch { buffer = buffer }
          ...
          forwardedNewsletterMessageInfo: {
            newsletterJid: '120363324407222638@newsletter',
            newsletterName: 'PLUTO BOT🤖', 
            serverMessageId: '' }, 
                ...options
                }
                })
...
let canalId = ["120363324407222638@newsletter", "120363324407222638@newsletter", "120363324407222638@newsletter", "120363324407222638@newsletter"]
let canalNombre = ["Pluto", "pluto ⚡ 𝐂𝐎𝐃𝐈𝐍𝐆", "pluto bot🤖", "pluto bot🤖"]
